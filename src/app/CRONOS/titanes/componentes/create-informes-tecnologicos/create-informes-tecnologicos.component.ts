...
@Component({
  selector: 'app-create-informes-tecnologicos',
  templateUrl: './create-informes-tecnologicos.component.html',
  styleUrls: ['./create-informes-tecnologicos.component.css']
})
export class CreateInformesTecnologicosComponent {
